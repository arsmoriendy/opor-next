...
function InputOTPGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        `flex items-center rounded-none has-aria-invalid:border-destructive
  ...
  return (
    <div
      ...
      className={cn(
        ...
        border-input text-xs transition-all outline-none first:rounded-none
        first:border-l last:rounded-none aria-invalid:border-destructive
        data-[active=true]:z-10 data-[active=true]:border-ring
        data-[active=true]:ring-1 data-[active=true]:ring-ring/50
