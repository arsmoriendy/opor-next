...
export default function Home() {
  return (
    ...
    >
      <main
        className="flex w-full max-w-3xl flex-1 flex-col items-center
      ...
      >
        ...
        >
          <h1
            className="max-w-xs text-3xl leading-10 font-semibold tracking-tight
              text-black dark:text-zinc-50"
          >
            To get started, edit the{" "}
            <code
              className="rounded bg-black/[.06] px-1.5 py-0.5 font-mono
                text-[0.9em] dark:bg-white/[.08]"
            >
              page.tsx
            </code>{" "}
            file.
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <a
            className="flex h-12 w-full items-center justify-center gap-2
              ...
              hover:bg-[#383838] md:w-[158px] dark:hover:bg-[#ccc]"
